...
function CarIntroduction() {
  return (
    <div className="min-h-[600px] mt-[50px] w-full flex flex-col mx-auto items-center">
            ...
            <div className={`w-[1331px] mb-[50px] flex justify-between items-center mx-auto ${styles.sections}`}>
            ...
            <div className="bg-[#222222] min-h-[300px] w-full">
                <div className={`w-[1331px] flex justify-between items-center mx-auto mb-[50px] mt-[50px] ${styles.sectionsT}`}>
            ...
            <div className={`w-[1331px] mb-[50px] flex justify-between items-center mx-auto ${styles.sectionsR}`}>
              <div className="flex flex-col w-[500px]">
