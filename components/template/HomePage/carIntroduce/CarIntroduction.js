...
function CarIntroduction() {
  return (
    <div className="min-h-[600px] mt-[50px] w-full flex flex-col mx-auto items-center">
            ...
            <div className="w-[1331px] mb-[100px] flex justify-between items-center mx-auto">
            ...
            <div className="bg-[#222222] min-h-[500px] w-full">
                <div className="w-[1331px] flex justify-between items-center mx-auto mb-[100px] mt-[100px]">
            ...
            <div className="w-[1331px] my-[100px] flex justify-between items-center mx-auto">
              <div className="flex flex-col w-[500px]">
