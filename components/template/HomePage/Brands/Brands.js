...
function Brands() {
  ...
  return (
    <div className="w-full min-h-[282px]">

        <div className="flex w-full justify-center">
            <div className="flex justify-center w-full h-[152px] items-center bg-[#3E3E3E]">
            <Image src={Fownix} width={400} height={400} alt={"hello"} className="w-[40%]" />
            </div>

            <div className="flex justify-center w-full h-[152px] items-center bg-[#2D2D2D]">
        ...
        {/* {brands.map((item,index) =>(
            <div className={`${index % 2 ==0 ? "bg-[#2D2D2D]" : 'bg-[#3E3E3E]'} flex justify-center w-[277px] h-[152px] items-center`}>
            </div>  
          )
        )
        } */}
