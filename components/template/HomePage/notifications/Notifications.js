...
function Notifications() {
  return (
    <div className="bg-gradient-to-r from-[#222222] to-[#6B6B6B] w-full min-h-[700px] flex justify-around items-center">
            ...
            <div className="w-[404px] h-[400px] bg-[#474747] flex flex-col items-center justify-start mx-auto rounded-xl">
                ...
                <div className="w-[450px] mt-10 flex justify-center ">
        ...
        <div className="w-[565px] h-[400px] flex flex-col items-center justify-start mx-auto rounded-xl">
            <div className="bg-[#474747] flex flex-col w-[665px] h-[122px] rounded-xl">
            ...
            <div className="flex mt-2 w-[665px]">
            ...
            <div className="w-[665px] h-[104px] bg-[#C38065] rounded-[45px] mt-5">
