...
function VerifyCodePage() {
    ...
    const myRoute = localStorage.getItem('myRoute')
         ...
         <div className={styles.child}>
           <div className={`flex flex-col items-center mt-[50px]`}>
             ...
             {inputValues.map((input, index) => (
                        ...
                        {goPay ?
                        <button  disabled type="button" className="py-2.5 outline-none px-5 my-5 mr-2 text-sm font-medium text-white rounded-2xl bg-[#C38065]  border-none border-gray-200 hover:bg-[#C38065] inline-flex items-center">
